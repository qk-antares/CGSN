...
from experiments.batch_mi.model.simgnn.DenseAttentionModule import DenseAttentionModule
...
class SimGNN(nn.Module):
    ...
    def forward_dense_gcn_layers(self, feat, adj, mask):
        ...
        feat_out = getattr(self, 'gnn{}'.format(self.gcn_numbers))(x=feat_in, adj=adj, mask=mask, add_loop=True)
        return feat_out
    ...
    def forward(self, batch_feat_1, batch_feat_2, batch_adj_1, batch_adj_2,
        ...
        :param batch_hb: b × 1
        :return: 相似度分数(b×1),GED(b×1),kl_loss(b×1)
        """
